//khi muốn dùng nhiều thành phần thì dùng JPanel
package view;
...
public class MyCalculator extends JFrame {
	public MyCalculator() {
		...
		JTextField jTextField = new JTextField(50); // 50 cột
		...
		add(jPanel_head, BorderLayout.NORTH);
		add(jPanel_buttons, BorderLayout.CENTER);
...
//		try-catch để hiển thị theo tùy loại hđh
		try {
